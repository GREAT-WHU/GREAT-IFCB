...
void MAT_LIBRARY_EXPORT QRZT(Matrix&, LowerTriangularMatrix&);

void MAT_LIBRARY_EXPORT QRZT(const Matrix&, Matrix&, Matrix&);

void MAT_LIBRARY_EXPORT QRZ(Matrix&, UpperTriangularMatrix&);

void MAT_LIBRARY_EXPORT QRZ(const Matrix&, Matrix&, Matrix&);
...
ReturnMatrix MAT_LIBRARY_EXPORT Cholesky(const SymmetricMatrix& S);

ReturnMatrix MAT_LIBRARY_EXPORT Cholesky(const SymmetricBandMatrix& S);
...
int MAT_LIBRARY_EXPORT SVD(const Matrix&, DiagonalMatrix&, Matrix&, Matrix&,
    bool=true, bool=true);

void MAT_LIBRARY_EXPORT SVD(const Matrix&, DiagonalMatrix&);
