...
// ************************** general utilities ****************************/
	...
	class MAT_LIBRARY_EXPORT LogAndSign
	{
		Real log_val;
		int sign_val;
	public:
	...
	class MAT_LIBRARY_EXPORT MatrixType
	{
	public:
		enum Attribute {
			Valid = 1,
	...
	public:
		...
		MAT_LIBRARY_EXPORT friend bool Rectangular(MatrixType a, MatrixType b, MatrixType c);
		MAT_LIBRARY_EXPORT friend bool Compare(const MatrixType&, MatrixType&);
	...
	class MAT_LIBRARY_EXPORT MatrixBandWidth
	{
	public:
		int lower_val;
		int upper_val;
	...
	class MAT_LIBRARY_EXPORT ArrayLengthSpecifier
	{
		int v;
	public:
...
#define MatrixTypeUnSp 0
	...
	class MAT_LIBRARY_EXPORT BaseMatrix : public Janitor
	{
	protected:
...
//   GeneralMatrix* Evaluate() { return Evaluate(MatrixTypeUnSp); }
	...
	class MAT_LIBRARY_EXPORT GeneralMatrix : public BaseMatrix         // declarable matrix types
	{
	...
	class MAT_LIBRARY_EXPORT Matrix : public GeneralMatrix
	{
	...
	public:
		...
		MAT_LIBRARY_EXPORT friend Real dotproduct(const Matrix& A, const Matrix& B);
		NEW_DELETE(Matrix)
	};

	/// Square matrix.
	class MAT_LIBRARY_EXPORT SquareMatrix : public Matrix
	{
		GeneralMatrix* Image() const;                // copy of matrix
	public:
		SquareMatrix() {}
	...
	/// Symmetric matrix.
	class MAT_LIBRARY_EXPORT SymmetricMatrix : public GeneralMatrix
	{
		GeneralMatrix* Image() const;                // copy of matrix
	public:
		SymmetricMatrix() {}
	...
	class MAT_LIBRARY_EXPORT UpperTriangularMatrix : public GeneralMatrix
	{
		GeneralMatrix* Image() const;                // copy of matrix
	public:
	...
	class MAT_LIBRARY_EXPORT LowerTriangularMatrix : public GeneralMatrix
	{
		GeneralMatrix* Image() const;                // copy of matrix
	public:
	...
	/// Diagonal matrix.
	class MAT_LIBRARY_EXPORT DiagonalMatrix : public GeneralMatrix
	{
		GeneralMatrix* Image() const;                // copy of matrix
	public:
		DiagonalMatrix() {}
	...
	/// Row vector.
	class MAT_LIBRARY_EXPORT RowVector : public Matrix
	{
		GeneralMatrix* Image() const;                // copy of matrix
	public:
	...
	/// Column vector.
	class MAT_LIBRARY_EXPORT ColumnVector : public Matrix
	{
		GeneralMatrix* Image() const;                // copy of matrix
	public:
	...
	class MAT_LIBRARY_EXPORT CroutMatrix : public GeneralMatrix
	{
		int* indx;
	...
	/// Band matrix.
	class MAT_LIBRARY_EXPORT BandMatrix : public GeneralMatrix
	{
		GeneralMatrix* Image() const;                // copy of matrix
	protected:
	...
	class MAT_LIBRARY_EXPORT UpperBandMatrix : public BandMatrix
	{
		GeneralMatrix* Image() const;                // copy of matrix
	public:
		UpperBandMatrix() {}
	...
	class MAT_LIBRARY_EXPORT LowerBandMatrix : public BandMatrix
	{
		GeneralMatrix* Image() const;                // copy of matrix
	public:
		LowerBandMatrix() {}
	...
	class MAT_LIBRARY_EXPORT SymmetricBandMatrix : public GeneralMatrix
	{
		GeneralMatrix* Image() const;                // copy of matrix
		void CornerClear() const;                    // set unused elements to zero
		short SimpleAddOK(const GeneralMatrix* gm);
	...
	class MAT_LIBRARY_EXPORT BandLUMatrix : public GeneralMatrix
	{
		int* indx;
		bool d;
	...
	/// Identity matrix.
	class MAT_LIBRARY_EXPORT IdentityMatrix : public GeneralMatrix
	{
		GeneralMatrix* Image() const;          // copy of matrix
	public:
		IdentityMatrix() {}
	...
	class MAT_LIBRARY_EXPORT GenericMatrix : public BaseMatrix
	{
		GeneralMatrix* gm;
	...
	/// \internal
	class MAT_LIBRARY_EXPORT MultipliedMatrix : public BaseMatrix
	{
	protected:
	...
	/// Sum of two matrices.
	/// \internal
	class MAT_LIBRARY_EXPORT AddedMatrix : public MultipliedMatrix
	{
	protected:
	...
	/// \internal
	class MAT_LIBRARY_EXPORT SPMatrix : public AddedMatrix
	{
	protected:
	...
	public:
		...
		MAT_LIBRARY_EXPORT friend SPMatrix SP(const BaseMatrix&, const BaseMatrix&);
	...
	/// \internal
	class MAT_LIBRARY_EXPORT KPMatrix : public MultipliedMatrix
	{
	protected:
	...
	public:
		...
		MatrixBandWidth bandwidth() const;
		GeneralMatrix* Evaluate(MatrixType mt = MatrixTypeUnSp);
		MAT_LIBRARY_EXPORT friend KPMatrix KP(const BaseMatrix&, const BaseMatrix&);
		NEW_DELETE(KPMatrix)
	};

	/// Two matrices horizontally concatenated.
	/// \internal
	class MAT_LIBRARY_EXPORT ConcatenatedMatrix : public MultipliedMatrix
	{
	protected:
	...
	/// \internal
	class MAT_LIBRARY_EXPORT StackedMatrix : public ConcatenatedMatrix
	{
	protected:
	...
	/// \internal
	class MAT_LIBRARY_EXPORT SolvedMatrix : public MultipliedMatrix
	{
	...
	/// \internal
	class MAT_LIBRARY_EXPORT SubtractedMatrix : public AddedMatrix
	{
	...
	/// \internal
	class MAT_LIBRARY_EXPORT ShiftedMatrix : public BaseMatrix
	{
	protected:
	...
	public:
		~ShiftedMatrix() {}
		GeneralMatrix* Evaluate(MatrixType mt = MatrixTypeUnSp);
		MAT_LIBRARY_EXPORT friend ShiftedMatrix operator+(Real f, const BaseMatrix& BM);
		NEW_DELETE(ShiftedMatrix)
	};

	/// Real minus matrix.
	/// \internal
	class MAT_LIBRARY_EXPORT NegShiftedMatrix : public ShiftedMatrix
	{
	protected:
	...
	public:
		~NegShiftedMatrix() {}
		GeneralMatrix* Evaluate(MatrixType mt = MatrixTypeUnSp);
		MAT_LIBRARY_EXPORT friend NegShiftedMatrix operator-(Real, const BaseMatrix&);
		NEW_DELETE(NegShiftedMatrix)
	};

	/// Any type of matrix times Real.
	/// \internal
	class MAT_LIBRARY_EXPORT ScaledMatrix : public ShiftedMatrix
	{
	...
	public:
		...
		GeneralMatrix* Evaluate(MatrixType mt = MatrixTypeUnSp);
		MatrixBandWidth bandwidth() const;
		MAT_LIBRARY_EXPORT friend ScaledMatrix operator*(Real f, const BaseMatrix& BM);
		NEW_DELETE(ScaledMatrix)
	};

	/// Any type of matrix times -1.
	/// \internal
	class MAT_LIBRARY_EXPORT NegatedMatrix : public BaseMatrix
	{
	protected:
		union { const BaseMatrix* bm; GeneralMatrix* gm; };
	...
	/// Transposed matrix.
	/// \internal
	class MAT_LIBRARY_EXPORT TransposedMatrix : public NegatedMatrix
	{
	...
	/// \internal
	class MAT_LIBRARY_EXPORT ReversedMatrix : public NegatedMatrix
	{
	...
	/// Inverse of matrix.
	/// \internal
	class MAT_LIBRARY_EXPORT InvertedMatrix : public NegatedMatrix
	{
	...
	/// \internal
	class MAT_LIBRARY_EXPORT RowedMatrix : public NegatedMatrix
	{
	...
	/// \internal
	class MAT_LIBRARY_EXPORT ColedMatrix : public NegatedMatrix
	{
	...
	/// \internal
	class MAT_LIBRARY_EXPORT DiagedMatrix : public NegatedMatrix
	{
	...
	/// \internal
	class MAT_LIBRARY_EXPORT MatedMatrix : public NegatedMatrix
	{
		int nr, nc;
	...
	/// \internal
	class MAT_LIBRARY_EXPORT ReturnMatrix : public BaseMatrix
	{
		GeneralMatrix* gm;
		int search(const BaseMatrix*) const;
	public:
	...
	/// \internal
	class MAT_LIBRARY_EXPORT GetSubMatrix : public NegatedMatrix
	{
		int row_skip;
		int row_number;
		int col_skip;
	...
	class MAT_LIBRARY_EXPORT LinearEquationSolver : public BaseMatrix
	{
		GeneralMatrix* gm;
	...
	class MAT_LIBRARY_EXPORT MatrixInput
	{
	...
	class MAT_LIBRARY_EXPORT SimpleIntArray : public Janitor
	{
	protected:
	...
	class MAT_LIBRARY_EXPORT RealStarStar
	{
		Real** a;
	public:
	...
	class MAT_LIBRARY_EXPORT ConstRealStarStar
	{
		const Real** a;
	public:
	...
	class MAT_LIBRARY_EXPORT NPDException : public Runtime_error
	{
	public:
	...
	class MAT_LIBRARY_EXPORT ConvergenceException : public Runtime_error
	{
	public:
		static unsigned long Select;
	...
	class MAT_LIBRARY_EXPORT SingularException : public Runtime_error
	{
	public:
		static unsigned long Select;
	...
	class MAT_LIBRARY_EXPORT OverflowException : public Runtime_error
	{
	public:
		static unsigned long Select;
	...
	class MAT_LIBRARY_EXPORT ProgramException : public Logic_error
	{
	protected:
		ProgramException();
	public:
	...
	/// Index exception.
	class MAT_LIBRARY_EXPORT IndexException : public Logic_error
	{
	public:
		static unsigned long Select;
	...
	class MAT_LIBRARY_EXPORT VectorException : public Logic_error
	{
	public:
		static unsigned long Select;
		VectorException();
	...
	class MAT_LIBRARY_EXPORT NotSquareException : public Logic_error
	{
	public:
		static unsigned long Select;
	...
	class MAT_LIBRARY_EXPORT SubMatrixDimensionException : public Logic_error
	{
	public:
		static unsigned long Select;
	...
	class MAT_LIBRARY_EXPORT IncompatibleDimensionsException : public Logic_error
	{
	public:
		static unsigned long Select;
	...
	class MAT_LIBRARY_EXPORT NotDefinedException : public Logic_error
	{
	public:
		static unsigned long Select;
	...
	class MAT_LIBRARY_EXPORT CannotBuildException : public Logic_error
	{
	public:
		static unsigned long Select;
	...
	class MAT_LIBRARY_EXPORT InternalException : public Logic_error
	{
	public:
	...
	MAT_LIBRARY_EXPORT bool operator==(const GeneralMatrix& A, const GeneralMatrix& B);
	MAT_LIBRARY_EXPORT bool operator==(const BaseMatrix& A, const BaseMatrix& B);
	MAT_LIBRARY_EXPORT inline bool operator!=(const GeneralMatrix& A, const GeneralMatrix& B)
	{
		return !(A == B);
	}
	MAT_LIBRARY_EXPORT inline bool operator!=(const BaseMatrix& A, const BaseMatrix& B)
	{
		return !(A == B);
	}
	...
	MAT_LIBRARY_EXPORT inline bool operator<=(const BaseMatrix& A, const BaseMatrix&)
	{
		A.IEQND(); return true;
	}
	MAT_LIBRARY_EXPORT inline bool operator>=(const BaseMatrix& A, const BaseMatrix&)
	...
	MAT_LIBRARY_EXPORT bool is_zero(const BaseMatrix& A);
	MAT_LIBRARY_EXPORT inline bool IsZero(const BaseMatrix& A) { return is_zero(A); }

	MAT_LIBRARY_EXPORT Real dotproduct(const Matrix& A, const Matrix& B);
	MAT_LIBRARY_EXPORT Matrix crossproduct(const Matrix& A, const Matrix& B);
	MAT_LIBRARY_EXPORT ReturnMatrix crossproduct_rows(const Matrix& A, const Matrix& B);
	MAT_LIBRARY_EXPORT ReturnMatrix crossproduct_columns(const Matrix& A, const Matrix& B);

	MAT_LIBRARY_EXPORT inline Real DotProduct(const Matrix& A, const Matrix& B)
	{
		return dotproduct(A, B);
	}
	MAT_LIBRARY_EXPORT inline Matrix CrossProduct(const Matrix& A, const Matrix& B)
	{
		return crossproduct(A, B);
	}
	MAT_LIBRARY_EXPORT inline ReturnMatrix CrossProductRows(const Matrix& A, const Matrix& B)
	{
		return crossproduct_rows(A, B);
	}
	MAT_LIBRARY_EXPORT inline ReturnMatrix CrossProductColumns(const Matrix& A, const Matrix& B)
	{
		return crossproduct_columns(A, B);
	}

	MAT_LIBRARY_EXPORT void newmat_block_copy(int n, Real* from, Real* to);

	// ********************* friend functions ******************************** //

	// Functions declared as friends - G++ wants them declared externally as well

	MAT_LIBRARY_EXPORT bool Rectangular(MatrixType a, MatrixType b, MatrixType c);
	MAT_LIBRARY_EXPORT bool Compare(const MatrixType&, MatrixType&);
	MAT_LIBRARY_EXPORT Real dotproduct(const Matrix& A, const Matrix& B);
	MAT_LIBRARY_EXPORT SPMatrix SP(const BaseMatrix&, const BaseMatrix&);
	MAT_LIBRARY_EXPORT KPMatrix KP(const BaseMatrix&, const BaseMatrix&);
	MAT_LIBRARY_EXPORT ShiftedMatrix operator+(Real f, const BaseMatrix& BM);
	MAT_LIBRARY_EXPORT NegShiftedMatrix operator-(Real, const BaseMatrix&);
	MAT_LIBRARY_EXPORT ScaledMatrix operator*(Real f, const BaseMatrix& BM);

	// ********************* inline functions ******************************** //

	MAT_LIBRARY_EXPORT inline LogAndSign log_determinant(const BaseMatrix& B)
	{
		return B.log_determinant();
	}
	MAT_LIBRARY_EXPORT inline LogAndSign LogDeterminant(const BaseMatrix& B)
	{
		return B.log_determinant();
	}
	MAT_LIBRARY_EXPORT inline Real determinant(const BaseMatrix& B)
	{
	...
	MAT_LIBRARY_EXPORT inline Real sum_square(const BaseMatrix& B) { return B.sum_square(); }
	MAT_LIBRARY_EXPORT inline Real SumSquare(const BaseMatrix& B) { return B.sum_square(); }
	MAT_LIBRARY_EXPORT inline Real norm_Frobenius(const BaseMatrix& B) { return B.norm_Frobenius(); }
	MAT_LIBRARY_EXPORT inline Real norm_frobenius(const BaseMatrix& B) { return B.norm_Frobenius(); }
	MAT_LIBRARY_EXPORT inline Real NormFrobenius(const BaseMatrix& B) { return B.norm_Frobenius(); }
	MAT_LIBRARY_EXPORT inline Real trace(const BaseMatrix& B) { return B.trace(); }
	MAT_LIBRARY_EXPORT inline Real Trace(const BaseMatrix& B) { return B.trace(); }
	MAT_LIBRARY_EXPORT inline Real sum_absolute_value(const BaseMatrix& B)
	{
		return B.sum_absolute_value();
	}
	MAT_LIBRARY_EXPORT inline Real SumAbsoluteValue(const BaseMatrix& B)
	{
		return B.sum_absolute_value();
	}
	MAT_LIBRARY_EXPORT inline Real sum(const BaseMatrix& B)
	{
		return B.sum();
	}
	MAT_LIBRARY_EXPORT inline Real Sum(const BaseMatrix& B)
	...
	MAT_LIBRARY_EXPORT inline Real maximum_absolute_value(const BaseMatrix& B)
	{
		return B.maximum_absolute_value();
	}
	MAT_LIBRARY_EXPORT inline Real MaximumAbsoluteValue(const BaseMatrix& B)
	{
		return B.maximum_absolute_value();
	}
	MAT_LIBRARY_EXPORT inline Real minimum_absolute_value(const BaseMatrix& B)
	{
		return B.minimum_absolute_value();
	}
	MAT_LIBRARY_EXPORT inline Real MinimumAbsoluteValue(const BaseMatrix& B)
	{
		return B.minimum_absolute_value();
	}
	MAT_LIBRARY_EXPORT inline Real maximum(const BaseMatrix& B) { return B.maximum(); }
	MAT_LIBRARY_EXPORT inline Real Maximum(const BaseMatrix& B) { return B.maximum(); }
	MAT_LIBRARY_EXPORT inline Real minimum(const BaseMatrix& B) { return B.minimum(); }
	MAT_LIBRARY_EXPORT inline Real Minimum(const BaseMatrix& B) { return B.minimum(); }
	MAT_LIBRARY_EXPORT inline Real norm1(const BaseMatrix& B) { return B.norm1(); }
	MAT_LIBRARY_EXPORT inline Real Norm1(const BaseMatrix& B) { return B.norm1(); }
	MAT_LIBRARY_EXPORT inline Real norm1(RowVector& RV) { return RV.maximum_absolute_value(); }
	MAT_LIBRARY_EXPORT inline Real Norm1(RowVector& RV) { return RV.maximum_absolute_value(); }
	MAT_LIBRARY_EXPORT inline Real norm_infinity(const BaseMatrix& B) { return B.norm_infinity(); }
	MAT_LIBRARY_EXPORT inline Real NormInfinity(const BaseMatrix& B) { return B.norm_infinity(); }
	MAT_LIBRARY_EXPORT inline Real norm_infinity(ColumnVector& CV)
	{
		return CV.maximum_absolute_value();
	}
	MAT_LIBRARY_EXPORT inline Real NormInfinity(ColumnVector& CV)
	{
		return CV.maximum_absolute_value();
	}
	MAT_LIBRARY_EXPORT inline bool IsZero(const GeneralMatrix& A) { return A.IsZero(); }
	MAT_LIBRARY_EXPORT inline bool is_zero(const GeneralMatrix& A) { return A.is_zero(); }


	MAT_LIBRARY_EXPORT inline MatrixInput MatrixInput::operator<<(int f) { return *this << (Real)f; }
	MAT_LIBRARY_EXPORT inline MatrixInput GeneralMatrix::operator<<(int f) { return *this << (Real)f; }
	MAT_LIBRARY_EXPORT inline MatrixInput BandMatrix::operator<<(int f) { return *this << (Real)f; }
	MAT_LIBRARY_EXPORT inline MatrixInput GetSubMatrix::operator<<(int f) { return *this << (Real)f; }
	MAT_LIBRARY_EXPORT inline ReversedMatrix BaseMatrix::Reverse() const { return reverse(); }
	MAT_LIBRARY_EXPORT inline RowedMatrix BaseMatrix::AsRow() const { return as_row(); }
	MAT_LIBRARY_EXPORT inline ColedMatrix BaseMatrix::AsColumn() const { return as_column(); }
	MAT_LIBRARY_EXPORT inline DiagedMatrix BaseMatrix::AsDiagonal() const { return as_diagonal(); }
	MAT_LIBRARY_EXPORT inline MatedMatrix BaseMatrix::AsMatrix(int m, int n) const
	{
		return as_matrix(m, n);
	}
	MAT_LIBRARY_EXPORT inline GetSubMatrix BaseMatrix::SubMatrix(int fr, int lr, int fc, int lc) const
	{
		return submatrix(fr, lr, fc, lc);
	}
	MAT_LIBRARY_EXPORT inline GetSubMatrix BaseMatrix::SymSubMatrix(int f, int l) const
	{
		return sym_submatrix(f, l);
	}
	MAT_LIBRARY_EXPORT inline GetSubMatrix BaseMatrix::Row(int f) const { return row(f); }
	MAT_LIBRARY_EXPORT inline GetSubMatrix BaseMatrix::Rows(int f, int l) const { return rows(f, l); }
	MAT_LIBRARY_EXPORT inline GetSubMatrix BaseMatrix::Column(int f) const { return column(f); }
	MAT_LIBRARY_EXPORT inline GetSubMatrix BaseMatrix::Columns(int f, int l) const
	{
		return columns(f, l);
	}
	MAT_LIBRARY_EXPORT inline Real BaseMatrix::AsScalar() const { return as_scalar(); }

	MAT_LIBRARY_EXPORT inline ReturnMatrix GeneralMatrix::ForReturn() const { return for_return(); }

	MAT_LIBRARY_EXPORT inline void swap(Matrix& A, Matrix& B) { A.swap(B); }
	MAT_LIBRARY_EXPORT inline void swap(SquareMatrix& A, SquareMatrix& B) { A.swap(B); }
	MAT_LIBRARY_EXPORT inline void swap(nricMatrix& A, nricMatrix& B) { A.swap(B); }
	MAT_LIBRARY_EXPORT inline void swap(UpperTriangularMatrix& A, UpperTriangularMatrix& B)
	{
		A.swap(B);
	}
	MAT_LIBRARY_EXPORT inline void swap(LowerTriangularMatrix& A, LowerTriangularMatrix& B)
	{
		A.swap(B);
	}
	MAT_LIBRARY_EXPORT inline void swap(SymmetricMatrix& A, SymmetricMatrix& B) { A.swap(B); }
	MAT_LIBRARY_EXPORT inline void swap(DiagonalMatrix& A, DiagonalMatrix& B) { A.swap(B); }
	MAT_LIBRARY_EXPORT inline void swap(RowVector& A, RowVector& B) { A.swap(B); }
	MAT_LIBRARY_EXPORT inline void swap(ColumnVector& A, ColumnVector& B) { A.swap(B); }
	MAT_LIBRARY_EXPORT inline void swap(CroutMatrix& A, CroutMatrix& B) { A.swap(B); }
	MAT_LIBRARY_EXPORT inline void swap(BandMatrix& A, BandMatrix& B) { A.swap(B); }
	MAT_LIBRARY_EXPORT inline void swap(UpperBandMatrix& A, UpperBandMatrix& B) { A.swap(B); }
	MAT_LIBRARY_EXPORT inline void swap(LowerBandMatrix& A, LowerBandMatrix& B) { A.swap(B); }
	MAT_LIBRARY_EXPORT inline void swap(SymmetricBandMatrix& A, SymmetricBandMatrix& B) { A.swap(B); }
	MAT_LIBRARY_EXPORT inline void swap(BandLUMatrix& A, BandLUMatrix& B) { A.swap(B); }
	MAT_LIBRARY_EXPORT inline void swap(IdentityMatrix& A, IdentityMatrix& B) { A.swap(B); }
	MAT_LIBRARY_EXPORT inline void swap(GenericMatrix& A, GenericMatrix& B) { A.swap(B); }
